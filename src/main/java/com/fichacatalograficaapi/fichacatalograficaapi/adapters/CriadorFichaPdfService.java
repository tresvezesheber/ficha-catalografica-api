package com.fichacatalograficaapi.fichacatalograficaapi.adapters;
...
@Service
public class CriadorFichaPdfService implements CriadorFichaPdf {

    @Override
    public byte[] criarPdf(Ficha ficha, String outputFileName) {
